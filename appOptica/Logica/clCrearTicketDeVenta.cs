...
{
    class clCrearTicketDeVenta
    {
        public static string nom;

        public clCrearTicketDeVenta(string nomArchivo)
        {
            nom = nomArchivo;
        }
    ...
    public class RawPrinterHelper
    {
        ...
        public static bool SendStringToPrinter(string szPrinterName, string szString)
        {
            ...
            string carpeta = ruta + "\\TicketsDeVenta";
            ...
            try
            {
                ...
                PdfWriter.GetInstance(document,
                              ...
                              new FileStream(carpeta + "\\"+clCrearTicketDeVenta.nom+".pdf",

                                     FileMode.Create));

                document.AddTitle("Ticket De Venta");
                document.AddCreator("Optisof");
                ...
                document.Add(new Paragraph(szString.ToString(), FontFactory.GetFont("Courier", 8)));
                document.Close();
